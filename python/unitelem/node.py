...
Primary developer-facing entrypoint for decentralised telemetry publishing,
zero-trust cryptographic verification, and CRDT state synchronization.
"""
...
class Node:
    """
    Decentralised Telemetry Node with integrated Zero-Trust Micro-Ledger Engine.
    """
    ...
    def start(self):
        """Starts discovery beacon and mesh transport background workers."""
        if self._running:
            return
        self._running = True
    ...
    def publish(self, topic: str, data: Any) -> None:
        ...
        Updates in-memory CRDT register and pushes a raw pointer to ring buffer.
        The mesh worker handles cryptographic hashing, signing, and serialization asynchronously.
        """
